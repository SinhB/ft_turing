...
def encode(machine: dict, tm_input):
    ...
    # Write alphabet encoding keys in file for later decoding
    with open("utm_encoding_keys.json", "w") as f:
        reverted_keys = dict((v, k) for k, v in alphabet.items())
        json.dump(reverted_keys, f)
